...
public class SearchResultAdapter extends ArrayAdapter<DataSnapshot> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView photoImageView = (ImageView) listItemView.findViewById(R.id.search_photo_image_view);
        Glide.with(photoImageView.getContext()).load(currentSearchResult.child("user_landlord_info").child("photoUrl").getValue().toString()).into(photoImageView);
