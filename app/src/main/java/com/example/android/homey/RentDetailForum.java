...
public class RentDetailForum extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseSDKs.mFirebaseStorage = FirebaseStorage.getInstance();
        FirebaseSDKs.mChatPhotosStorageReference = FirebaseSDKs.mFirebaseStorage.getReference().child("users");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PLACE_PICKER_REQUEST) {
            ...
            StorageReference photoRef = FirebaseSDKs.mChatPhotosStorageReference.child(FirebaseSDKs.user.getUid()).child(selectedImageUri.getLastPathSegment());
    ...
    private void saveUserDetails() {
        RentDetailForumTemplate rentDetailForumTemplate = new RentDetailForumTemplate(mAddress, mCity, mState, mZipCode, mLatitude, mLongitude, mPlaceID, room, mACRooms, mAttachedWashrooms, mParking, mWifi, mDescription, mPrice, userPhotoUrl);
