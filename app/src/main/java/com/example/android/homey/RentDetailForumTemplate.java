...
public class RentDetailForumTemplate {
    ...
    public RentDetailForumTemplate(String mAddress, String mCity, String mState, String mZipCode, double mLatitude, double mLongitude, String mPlaceID,int mRooms, boolean mACRooms, boolean mAttachedWashrooms, boolean mParking, boolean mWifi, String mDescription, String mPrice, String photoUrl){
