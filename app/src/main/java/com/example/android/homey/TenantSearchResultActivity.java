    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        FirebaseSDKs.mDatabaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                ...
                final SearchResultAdapter adapter = new SearchResultAdapter(TenantSearchResultActivity.this, searchResultArray);
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        DataSnapshot currentDataSnapshot = adapter.getItem(position);
                        Intent intent = new Intent(TenantSearchResultActivity.this, DisplayLandlordDetailsActivity.class);
                        intent.putExtra("current_uid", currentDataSnapshot.getKey());
